...
pub struct CollectiveConsciousness {
    ...
    pub emergent_intelligence: f32,      // Intelligence collective émergente
    pub collective_creativity: f32,      // Créativité collective
    pub coherence_level: f32,            // Niveau de cohérence du groupe
    pub evolution_rate: f32,             // Vitesse d'évolution collective
}
...
impl CollectiveConsciousness {
    ...
    pub fn backpropagate_wisdom(&mut self, mesh: &mut crate::thevie::neural_mesh::NeuralMesh, delta: f32) {
        let boost = delta * 0.18; // Plus fort qu'avant
    ...
    /// Ajoute une expérience à la mémoire collective (avec résumé intelligent)
